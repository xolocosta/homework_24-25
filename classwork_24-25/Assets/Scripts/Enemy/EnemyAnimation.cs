...
{
    private const string _WALK_FRONT_ANIMATION_NAME = "enemy_walk_front";
    private const string _WALK_BACK_ANIMATION_NAME = "enemy_walk_back";
    private const string _WALK_SIDE_ANIMATION_NAME = "enemy_walk_side";

    private const string _IDLE_FRONT_ANIMATION_NAME = "enemy_idle_front";
    private const string _IDLE_BACK_ANIMATION_NAME = "enemy_idle_back";
    private const string _IDLE_SIDE_ANIMATION_NAME = "enemy_idle_side";

    private const string _ATTACK_FRONT_ANIMATION_NAME = "enemy_attack_front";
    private const string _ATTACK_BACK_ANIMATION_NAME = "enemy_attack_back";
    private const string _ATTACK_SIDE_ANIMATION_NAME = "enemy_attack_side";

    private const string _ENEMY_DEATH_ANIMATION_NAME = "enemy_death";
    ...
    public EnemyAnimation(UnityEngine.Animator animator, UnityEngine.Transform transform)
    {
        _animator = animator;
    ...
    {
        _animator.Play(_ENEMY_DEATH_ANIMATION_NAME);
    }
